...
export const AutoLinkAnnounceExtension = mod.AutoLinkAnnounceExtension;
...
export const autoLinkEmailMatcher = mod.autoLinkEmailMatcher;
export const autoLinkUrlMatcher = mod.autoLinkUrlMatcher;
