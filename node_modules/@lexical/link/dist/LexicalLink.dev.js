...
class LinkNode extends lexical.ElementNode {
  ...
  createDOM(config) {
    const element = lexical.$getDocument().createElement('a');
...
const AutoLinkAnnounceExtension = {
  ...
  register(editor, _config, state) {
    ...
    return extension.effect(() => disabled.value ? undefined : editor.registerMutationListener(AutoLinkNode, nodes => {
      let createdCount = 0;
...
exports.AutoLinkAnnounceExtension = AutoLinkAnnounceExtension;
...
exports.autoLinkEmailMatcher = autoLinkEmailMatcher;
exports.autoLinkUrlMatcher = autoLinkUrlMatcher;
