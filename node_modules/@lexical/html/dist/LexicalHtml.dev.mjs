...
import { $getEditor, createState, isDOMDocumentNode, isHTMLElement, $getEditorDOMRenderConfig, DEFAULT_EDITOR_DOM_CONFIG, getRegisteredSubtypeMap, $isLexicalNode, iterStaticNodeConfigChain, $fullReconcile, shallowMergeConfig, RootNode, $getDocument, isDOMTextNode, isBlockDomNode, isInlineDomNode, $isElementNode, $isBlockElementNode, $isDecoratorNode, $isLineBreakNode, $createParagraphNode, $setFormatFromDOM, setNodeIndentFromDOM, $setDirectionFromDOM, $generateNodesFromRawText, $createTextNode, isOnlyChildInBlockNode, isLastChildInBlockNode, $createLineBreakNode, $isTextNode, IS_BOLD, IS_ITALIC, IS_UNDERLINE, IS_STRIKETHROUGH, TEXT_TYPE_TO_FORMAT, IS_SUBSCRIPT, IS_SUPERSCRIPT, IS_HIGHLIGHT, IS_CODE, $getRoot, $getSelectionSlotFrame, $assumeActiveEditor, $isNodeSelection, isDocumentFragment, $isRootOrShadowRoot, ArtificialNode__DO_NOT_USE } from 'lexical';
...
function styleFormatOverride(style) {
  ...
  if (textTransform === 'lowercase') {
    ...
    clear |= TEXT_TYPE_TO_FORMAT.lowercase | TEXT_TYPE_TO_FORMAT.uppercase | TEXT_TYPE_TO_FORMAT.capitalize;
  }
