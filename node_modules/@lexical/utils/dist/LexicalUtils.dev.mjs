...
function $insertNodeToNearestRoot(node) {
  ...
  const insertCaret = $insertNodeToNearestRootAtCaret(node, initialCaret, $hasContentAfter(initialCaret) ? {
