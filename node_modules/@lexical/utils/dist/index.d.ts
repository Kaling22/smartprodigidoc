...
import { $insertNodeToNearestRootAtCaret, type CaretDirection, type EditorState, type ElementNode, type Klass, type LexicalEditor, type LexicalNode, type NodeCaret, type PasteCommandType, type PointType, type SiblingCaret, type StateConfig, type ValueOrUpdater } from 'lexical';
...
export { $findMatchingParent, $getAdjacentSiblingOrParentSiblingCaret, $isBlockFullySelected, $splitNode, addClassNamesToElement, isBlockDomNode, isHTMLAnchorElement, isHTMLElement, isInlineDomNode, mergeRegister, removeClassNamesFromElement, } from 'lexical';
