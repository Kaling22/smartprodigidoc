...
import { RootElementExtension, signal, effect, namedSignals } from '@lexical/extension';
import { mergeRegister, UNDO_COMMAND, COMMAND_PRIORITY_LOW, REDO_COMMAND, createRefCountedRegistry, getActiveElementDeep, isHTMLElement, registerEventListener, KEY_DOWN_COMMAND, isDOMShadowRoot, getComposedEventTarget } from 'lexical';
...
function registerFocusManager(editor, toolbar, options = {}) {
  ...
  return mergeRegister(editor.registerCommand(KEY_DOWN_COMMAND, event => {
    ...
    firstItem.focus();
    return true;
  }, COMMAND_PRIORITY_LOW), registerEventListener(toolbar, 'keydown', handler));
}
...
const HistoryAnnounceExtension = {
  ...
  register(editor, _config, state) {
    ...
    return effect(() => disabled.value ? undefined : mergeRegister(editor.registerCommand(UNDO_COMMAND, () => {
      announce(undone.peek());
      return false;
    }, COMMAND_PRIORITY_LOW), editor.registerCommand(REDO_COMMAND, () => {
...
const EditorModeAnnounceExtension = {
  ...
  register(editor, _config, state) {
    ...
    return effect(() => disabled.value ? undefined : editor.registerEditableListener(isEditable => {
...
export { AriaLiveRegionExtension, EditorModeAnnounceExtension, FocusManagerExtension, FocusTrapExtension, HistoryAnnounceExtension, RovingTabIndexExtension };
