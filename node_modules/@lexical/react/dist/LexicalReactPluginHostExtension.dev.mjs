...
import { getExtensionDependencyFromEditor, effect, untracked, signal } from '@lexical/extension';
import { ReactExtension } from '@lexical/react/ReactExtension';
import { ReactProviderExtension } from '@lexical/react/ReactProviderExtension';
import { createCommand, mergeRegister, COMMAND_PRIORITY_CRITICAL, COMMAND_PRIORITY_EDITOR } from 'lexical';
 ...
 * {@link ReactPluginHostExtension}.
 */
const REACT_PLUGIN_HOST_MOUNT_ROOT_COMMAND = /* @__PURE__ */createCommand('REACT_PLUGIN_HOST_MOUNT_ROOT_COMMAND');
/**
 ...
 * {@link ReactPluginHostExtension}.
 */
const REACT_PLUGIN_HOST_MOUNT_PLUGIN_COMMAND = /* @__PURE__ */createCommand('REACT_PLUGIN_HOST_MOUNT_PLUGIN_COMMAND');
 ...
 */
const ReactPluginHostExtension = {
  ...
  dependencies: [ReactProviderExtension, ([ReactExtension, {
