...
import { useMemo, useSyncExternalStore, Suspense, useLayoutEffect, useEffect, useState } from 'react';
...
function useRootElement(editor) {
  const [subscribe, getSnapshot] = useMemo(() => [editor.registerRootListener.bind(editor), editor.getRootElement.bind(editor)], [editor]);
...
function canShowPlaceholderFromCurrentEditorState(editor) {
  const currentCanShowPlaceholder = editor.read('latest', $canShowPlaceholderCurry(editor.isComposing()));
