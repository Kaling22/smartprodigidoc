...
return c(u,{children:[/*#__PURE__*/s(p,{editor:n,...r,ref:i}),null!=a&&/*#__PURE__*/s(y,{editor:n,content:a})]})}function y({content:e,editor:t}){const i=function(e){const[t,i]=r(()=>x(e));return f(()=>{function t(){const t=x(e);i(t)}return t(),d(e.registerUpdateListener(()=>{t()}),e.registerEditableListener(()=>{t()}))},[e]),t}(t),[a,n]=r(t.isEditable());if(f(()=>(n(t.isEditable()),t.registerEditableListener(e=>{n(e)})),[t]),!i)return null;let o=null;return"function"==typeof e?o=e(a):null!==e&&(o=e),null===o?null:/*#__PURE__*/s("div",{"aria-hidden":!0,children:o})}export{v as ContentEditable,p as ContentEditableElement};
