...
function tryToPositionRange(leadOffset, range, editorWindow, rootElement) {
    ...
    const updateListener = () => {
      editor.read('latest', () => {
        ...
        if (match !== null && (ignoreEntityBoundary || !isSelectionOnEntityBoundary(editor, match.leadOffset))) {
          const isRangePositioned = tryToPositionRange(match.leadOffset, range, editorWindow, editor.getRootElement());
