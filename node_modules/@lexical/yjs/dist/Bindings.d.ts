 ...
 */
export declare function createYjsBinding({ editor, id, doc, docMap, excludedProperties, rootName, getXmlText, }: CreateYjsBindingOptions): Binding;
...
export declare function createBindingV2__EXPERIMENTAL(editor: LexicalEditor, id: string, doc: Doc | null | undefined, docMap: Map<string, Doc>, options?: CreateBindingV2Options__EXPERIMENTAL): BindingV2;
