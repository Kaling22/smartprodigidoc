 ...
 *
 */
import { type BaseSelection, type ElementNode, type Klass, type LexicalNode, type LineBreakNode, type TextFormatType, type TextNode } from 'lexical';
...
export type ElementTransformer = {
     ...
     */
    export: (node: LexicalNode, traverseChildren: (node: ElementNode) => string, selection?: BaseSelection | null) => string | null;
    regExp: RegExp;
    /**
...
export type MultilineElementTransformer = {
     ...
     */
    children: LexicalNode[] | null, startMatch: string[], endMatch: string[] | null, 
    /**
 ...
 */
export declare function isTableRowDivider(line: string): boolean;
export declare const listMarkerState: import("lexical").StateConfig<"mdListMarker", string>;
export declare const codeFenceState: import("lexical").StateConfig<"mdCodeFence", string>;
/**
 ...
 */
export declare const codeMetaState: import("lexical").StateConfig<"mdCodeMeta", string>;
 ...
 * @internal
 */
export declare function withListIndentColumns<T>(joinLooseLists: boolean, fn: () => T): T;
...
export declare function getCodeSpanDelimiter(content: string): {
    fence: string;
    padded: string;
};
...
export declare const ELEMENT_TRANSFORMERS: ElementTransformer[];
export declare const MULTILINE_ELEMENT_TRANSFORMERS: MultilineElementTransformer[];
export declare const TEXT_FORMAT_TRANSFORMERS: TextFormatTransformer[];
export declare const TEXT_MATCH_TRANSFORMERS: TextMatchTransformer[];
