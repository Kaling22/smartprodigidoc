...
export const HeadingAnnounceExtension = mod.HeadingAnnounceExtension;
...
export const RichTextImportExtension = mod.RichTextImportExtension;
export const RichTextImportRules = mod.RichTextImportRules;
export const ShadowRootQuoteRule = mod.ShadowRootQuoteRule;
export const defaultShouldHandlePasteAsFiles = mod.defaultShouldHandlePasteAsFiles;
export const eventFiles = mod.eventFiles;
export const quoteShadowRootState = mod.quoteShadowRootState;
