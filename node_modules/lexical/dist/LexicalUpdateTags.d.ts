 ...
 */
export declare const CUT_TAG = "cut";
/**
 ...
 */
export declare const COMPOSITION_START_TAG = "composition-start";
/**
 * The update was triggered by composition-end
 */
export declare const COMPOSITION_END_TAG = "composition-end";
/**
 * The set of known update tags to help with TypeScript suggestions.
 */
export type UpdateTag = typeof COLLABORATION_TAG | typeof CUT_TAG | typeof FOCUS_TAG | typeof HISTORIC_TAG | typeof HISTORY_MERGE_TAG | typeof HISTORY_PUSH_TAG | typeof PASTE_TAG | typeof SKIP_COLLAB_TAG | typeof SKIP_DOM_SELECTION_TAG | typeof SKIP_SCROLL_INTO_VIEW_TAG | typeof COMPOSITION_START_TAG | typeof COMPOSITION_END_TAG | (string & {});
