...
import { type BaseSelection, type RangeSelection } from '.';
import { DequeSet } from './LexicalDequeSet';
import { type EditorState, type SerializedEditorState } from './LexicalEditorState';
import { type DOMConversion, type DOMConversionMap, type DOMExportOutput, type DOMExportOutputMap, LexicalNode, type LexicalPrivateDOM, type NodeKey } from './LexicalNode';
import { type SharedNodeState } from './LexicalNodeState';
import { type UpdateTag } from './LexicalUpdateTags';
 ...
 * ```
 */
export type CommandPayloadType<TCommand extends AnyLexicalCommand> = TCommand extends LexicalCommand<infer TPayload> ? TPayload : never;
export type CommandPayloadArgs<TPayload> = [
    TPayload extends undefined ? true : never
] extends [never] ? [payload: TPayload] : [payload?: TPayload];
...
export declare class LexicalEditor {
     ...
     */
    dispatchCommand<TCommand extends AnyLexicalCommand>(type: TCommand, ...args: CommandPayloadArgs<CommandPayloadType<TCommand>>): boolean;
    /**
