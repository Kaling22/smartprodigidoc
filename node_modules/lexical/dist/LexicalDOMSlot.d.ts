...
export declare function isDecoratorBoundaryAnchorDOM(node: Node | null): node is Element & {
    [DecoratorBoundaryAnchorDOMBrand]: never;
};
...
export declare class ElementDOMSlot<T extends HTMLElement = HTMLElement> extends DOMSlot<T> {
     ...
     */
    setDecoratorBoundaryAnchor(edge: DecoratorBoundaryEdge, enabled: boolean): void;
    /**
     * @internal
     */
