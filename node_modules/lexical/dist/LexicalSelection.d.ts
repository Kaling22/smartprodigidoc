 ...
 */
export declare function INTERNAL_$expandSelectionToWholeDocument(selection: RangeSelection): void;
/**
 ...
 */
export declare function $selectionTouchesElement(selection: RangeSelection, parentNode: LexicalNode): boolean;
