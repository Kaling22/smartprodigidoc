...
function SelectTrigger({
  ...
  return /* @__PURE__ */ jsxs(
    Select$1.Trigger,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx(Select$1.Icon, { asChild: true, children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: UnfoldMoreIcon, strokeWidth: 2, className: "pointer-events-none size-4 text-muted-foreground" }) })
      ]
    }
  );
}
...
function SelectItem({
  ...
  return /* @__PURE__ */ jsxs(
    Select$1.Item,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { className: "pointer-events-none absolute right-2 flex size-4 items-center justify-center", children: /* @__PURE__ */ jsx(Select$1.ItemIndicator, { children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: Tick02Icon, strokeWidth: 2, className: "pointer-events-none" }) }) }),
...
function SelectScrollUpButton({
  ...
  return /* @__PURE__ */ jsx(
    Select$1.ScrollUpButton,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: ArrowUp01Icon, strokeWidth: 2 })
    }
  );
}
function SelectScrollDownButton({
  ...
  return /* @__PURE__ */ jsx(
    Select$1.ScrollDownButton,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: ArrowDown01Icon, strokeWidth: 2 })
    }
  );
}
export {
