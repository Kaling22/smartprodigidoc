...
import { u as useWizard, a as unggahGambar, k as keBerkas, b as kecilkan, B as Bantuan, P as PapanKetersediaan, c as PenyediaWizard, x as xsrf } from "./PapanKetersediaan-Hogkj4By.js";
...
import { b as barisLogBaru, R as RevisionLog, a as barisLogBerisi } from "./RevisionLog-CNBSGoSn.js";
import "radix-ui";
...
function RichText({
  ...
  const kotakEditor = useRef(null);
  const kotakToolbar = useRef(null);
  ...
  const sapuTempelan = async (q) => {
    ...
    try {
      let img;
      let jaga = 0;
      while ((img = q.root.querySelector('img[src^="data:"]')) && jaga++ < 20) {
        ...
        const di = blot && "length" in blot ? q.getIndex(blot) : null;
        if (di === null) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "pp-rt", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "hidden",
      ...
      /* @__PURE__ */ jsxs("div", { ref: kotakToolbar, className: "ql-toolbar ql-snow", children: [
        /* @__PURE__ */ jsxs("span", { className: "ql-formats", children: [
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-bold", title: "Tebal", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: TextBoldIcon, strokeWidth: 1.5, className: "size-4" }) }),
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-italic", title: "Miring", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: TextItalicIcon, strokeWidth: 1.5, className: "size-4" }) }),
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-underline", title: "Garis bawah", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: TextUnderlineIcon, strokeWidth: 1.5, className: "size-4" }) })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "ql-formats", children: /* @__PURE__ */ jsx("button", { type: "button", className: "ql-blockquote", title: "Kutipan", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: QuoteDownIcon, strokeWidth: 1.5, className: "size-4" }) }) }),
        /* @__PURE__ */ jsxs("span", { className: "ql-formats", children: [
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-list", value: "ordered", title: "Daftar bernomor", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: LeftToRightListNumberIcon, strokeWidth: 1.5, className: "size-4" }) }),
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-list", value: "bullet", title: "Daftar berbutir", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: LeftToRightListBulletIcon, strokeWidth: 1.5, className: "size-4" }) })
        ] }),
        /* @__PURE__ */ jsxs("span", { className: "ql-formats", children: [
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-image", title: "Gambar", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: Image01Icon, strokeWidth: 1.5, className: "size-4" }) }),
          /* @__PURE__ */ jsx("button", { type: "button", className: "ql-clean", title: "Bersihkan format", children: /* @__PURE__ */ jsx(HugeiconsIcon, { icon: EraserIcon, strokeWidth: 1.5, className: "size-4" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { ref: kotakEditor })
    ] }),
    mengunggah ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-primary", children: "Mengunggah gambar…" }) : null,
    galat ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-destructive", children: galat }) : null,
    /* @__PURE__ */ jsx(
      "input",
      {
...
function validasiWajib(root) {
  ...
  root.querySelectorAll("input[type=hidden][data-pp-rich]").forEach((el) => {
    ...
    if (kosong && !pertama) pertama = kotak.querySelector(".ql-editor") ?? kotak;
  });
  return pertama;
}
